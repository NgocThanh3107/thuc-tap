    ...
    return(
        <div className="table-style">
            ...
            <div className="c-c">
                ...
                <p className="add"><Link onClick={(e) => {e.preventDefault(); navigate('/administrator/internship/builder/formfield/create.html')}}><i className="fa fa-plus-circle" aria-hidden="true"></i> Add New</Link></p>
            </div>
